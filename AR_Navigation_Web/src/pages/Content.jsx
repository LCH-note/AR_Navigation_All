            ...
            <div className="w-80 border-r border-slate-800 bg-[#151a25] flex flex-col flex-shrink-0 z-10">
                <div className="p-5 border-b border-slate-800 bg-[#151a25]">
                    ...
                    <div className="relative w-full">
                        ...
                        <input
                            className="block w-full pl-10 pr-3 py-2 border border-slate-700 rounded-lg bg-[#111318] placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-primary sm:text-sm text-white transition-shadow"
