...
<p align="center">
<img height="390" alt="캡스톤 AR 내비게이션 사진 12" src="https://github.com/user-attachments/assets/2e1a8e90-5c5c-4876-82e5-e7d5afec4aee" />
<img height="390" alt="캡스톤 AR 내비게이션 사진 11" src="https://github.com/user-attachments/assets/8a68dadd-d046-4e52-a46f-fa5c16a26972" />
</p>

<p align="center">
VPS 공간 맵핑, AR 화살표 길안내 및 AR 경로 시각화 화면입니다.<br>
Immersal SDK 기반 위치 인식 기술과 NavMesh 경로 데이터를 활용하여 사용자의 현재 위치를 인식하고 목적지까지 실시간 AR 내비게이션 서비스를 제공합니다.
</p>
